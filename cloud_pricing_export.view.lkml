...
view: cloud_pricing_export {
            ...
            THEN(
              CASE
                ...
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'disk->ssd->capacity')
                  THEN 'SSD Capacity'
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'gcp->compute->persistent disk->snapshots')
                  THEN 'Snapshots'
                ...
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'licenses') THEN 'Licensing fee'
                -- Compute Engine GPU
  ...
  dimension: pricing_category {
    sql: CASE
          ...
          WHEN ${service__description} = 'Compute Engine' and ${category} = 'Marketplace Services' THEN 'Marketplace Services'
          WHEN ${service__description} = 'Compute Engine' and ${category} = 'Third Party Services'
